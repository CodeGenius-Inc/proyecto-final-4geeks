...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.tipo_combustible) {
      setAlert({
        show: true,
        variant: "danger",
        message: "❌ Debes seleccionar un tipo de combustible",
      });
      setTimeout(
        () => setAlert({ show: false, variant: "", message: "" }),
        5000
    ...
    if (!cantidadNumerica || cantidadNumerica < 100) {
      setAlert({
        show: true,
        variant: "danger",
        message: "❌ La cantidad mínima es 100 galones",
      });
      setTimeout(
        () => setAlert({ show: false, variant: "", message: "" }),
        5000
    ...
    try {
      ...
      setAlert({
        ...
        variant: "success",
        message:
          "¡Pedido registrado exitosamente! Nos pondremos en contacto con usted pronto. Si desea cancelar su pedido, puede hacerlo llamando a nuestro teléfono: +1-800-FUELFLOW",
      });
  ...
  return (
    <div className="home-container">
          ...
          <Row className="align-items-center min-vh-100 py-5">
            <Col lg={7} className="text-white">
              ...
              <p className="lead fs-3 mb-4 animate-slide-up">
                Tu partner de confianza para distribución de combustible a
                domicilio. Con más de 10 años de experiencia entregando en toda
                la región.
              </p>
              ...
              <div className="contact-info animate-slide-up-delay-2">
                ...
                <a class="btn btn-light btn-lg" href="+1-800-38353569">
                  📞 +1-800-FUELFLOW
                </a>
              </div>
            </Col>
            ...
            <Col lg={6}>
              <div>
                ...
                <p className="lead mb-4 text-dark">
                  ...
                  equipados con tecnología avanzada y sistemas de seguridad
                  certificados.
                </p>
        ...
        <Container>
          <div className="text-center mb-5">
            ...
            <p className="text-muted lead">
              Combustibles de alta calidad para todas tus necesidades
            </p>
          </div>
            ...
            <Col md={4}>
              <Card className="product-card h-100 border-0 shadow-sm">
                ...
                <Card.Body className="text-center p-4">
                  ...
                  <Card.Text className="text-muted">
                    Combustible diesel premium para vehículos comerciales e
                    industriales. Máxima potencia y durabilidad.
                  </Card.Text>
                  <div className="product-features mt-3">
            ...
            <Col md={4}>
              <Card className="product-card h-100 border-0 shadow-sm">
                ...
                <Card.Body className="text-center p-4">
                  ...
                  <Card.Text className="text-muted">
                    Máxima calidad para el mayor rendimiento. Protege tu motor y
                    mejora el desempeño de tu vehículo.
                  </Card.Text>
                  <div className="product-features mt-3">
      ...
      <section className="services-section py-5">
        <Container>
          <div className="text-center mb-5">
            ...
            <p className="text-muted lead">
              Soluciones de abastecimiento a la medida de tus operaciones
            </p>
          </div>
          ...
          <Row className="g-4">
            <Col md={6} lg={4}>
              <Card className="product-card h-100 border-0 shadow-sm">
                ...
                <Card.Body className="text-center p-4">
                  <Card.Title className="h4 mt-3">
                    Llenado para Barcos
                  </Card.Title>
                  <Card.Text className="text-muted">
                    Abastecemos combustible de forma segura y rápida
                    directamente en muelles y embarcaciones.
                  </Card.Text>
            ...
            <Col md={6} lg={4}>
              <Card className="product-card h-100 border-0 shadow-sm">
                ...
                <Card.Body className="text-center p-4">
                  ...
                  <Card.Text className="text-muted">
                    Llevamos el combustible directamente a tu ubicación, con
            ...
            <Col md={6} lg={4}>
              <Card className="product-card h-100 border-0 shadow-sm">
                ...
                <Card.Body className="text-center p-4">
                  ...
                  <Card.Text className="text-muted">
                    Ofrecemos soluciones personalizadas de entrega y
                    almacenamiento para flotas, fábricas y estaciones.
                  </Card.Text>
                  <div className="product-features mt-3">
        ...
        <Container>
          ...
          <Row className="g-4">
            <Col md={6} lg={4} className="d-flex">
              <div className="why-card p-4 shadow-sm rounded-4 text-center h-100 w-100 d-flex flex-column">
                ...
                <p className="text-muted mb-0 flex-grow-1">
                  Entregamos en menos de 2 horas en la mayoría de los casos. Tu
                  tiempo es valioso, lo respetamos.
                </p>
              </div>
            </Col>
            ...
            <Col md={6} lg={4} className="d-flex">
              <div className="why-card p-4 shadow-sm rounded-4 text-center h-100 w-100 d-flex flex-column">
                ...
                <p className="text-muted mb-0 flex-grow-1">
                  Flota moderna con sistemas de seguridad avanzados y personal
            ...
            <Col md={6} lg={4} className="d-flex">
              <div className="why-card p-4 shadow-sm rounded-4 text-center h-100 w-100 d-flex flex-column">
                ...
                <p className="text-muted mb-0 flex-grow-1">
                  Estamos disponibles día y noche, los 365 días del año para
            ...
            <Col md={6} lg={4} className="d-flex">
              <div className="why-card p-4 shadow-sm rounded-4 text-center h-100 w-100 d-flex flex-column">
                ...
                <p className="text-muted mb-0 flex-grow-1">
                  Más de 500 clientes satisfechos nos respaldan. Tu satisfacción
      ...
      <section
        className="form-section py-5"
        id="formulario"
        ref={formularioRef}
      >
        <Container>
          <h2 className="section-title text-center mb-4">
            Solicita tu <span className="text-primary">Entrega</span>
          </h2>
                ...
                <Card.Body className="p-4">
                  ...
                  <Form onSubmit={handleSubmit}>
                    ...
                    <Form.Group className="mb-3">
                      ...
                      >
                        <option value="normal">
                          🟢 Normal - Entrega en 2-4 horas
                        </option>
                        <option value="urgente">
                          🟡 Urgente - Entrega en 1-2 horas
                        </option>
                        <option value="critico">
                          🔴 Crítico - Entrega inmediata
                        </option>
                      </Form.Select>
                    </Form.Group>
          ...
          <Row>
            <Col md={4}>
              ...
              <p className="text-white-50 mb-0">
                Tu aliado confiable en distribución de combustible.
              </p>
            </Col>
            <Col md={4}>
              ...
              <p className="mb-0 text-white-50">Oficina: Av. Principal 123</p>
            </Col>
            <Col md={4}>
